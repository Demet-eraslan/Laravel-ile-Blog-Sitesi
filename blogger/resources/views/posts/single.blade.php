      ...
      <div class="row blog-entries element-animate">
        ...
        <div class="col-md-12 col-lg-8 main-content">
          ...
          @auth
            ...
            <a class="btn btn-primary" href="{{ route('posts.delete', $single->id)}}" role="button">Sil</a>
            @endif
          @endauth

        @auth
          @if(Auth::user()->id == $single->user_id)
          <a  class="btn btn-primary" href="{{ route('posts.edit', $single->id)}}" role="button">Güncelle</a>
          @endif
        @endauth
            ...
            <div class="comment-form-wrap pt-5">
              ...
              <form action="{{ route('comment.store')}}" method="POST" class="p-5 bg-light">
                ...
                <div class="form-group">
                  ...
                  <textarea placeholder="Yorum Yazınız." name="comment" id="message" cols="30" rows="10" class="form-control"></textarea>
                </div>
                @auth
                <div class="form-group">
        ...
        @if ($moreBlogs->count()>0)
          ...
          <div class="col-md-6 col-lg-3">
            <div class="blog-entry">
              ...
              <p><a href="{{ route('posts.single', $moreBlog->id)}}" class="read-more">Okumaya devam et</a></p>
            </div>
          </div>
        @endforeach
        @else
        <div class="alert alert-success">
          <p>Bu kategoride daha fazla gönderi yok</p>
        </div>
        @endif
