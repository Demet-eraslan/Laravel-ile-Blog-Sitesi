...
<section class="section posts-entry">
    <div class="container">
        <div class="row mb-4">
            <div class="col-sm-6">
                <h2 class="posts-entry-title">İş Dünyası</h2>
            </div>
            <div class="col-sm-6 text-sm-end"><a href="category.html" class="read-more">Hepsini Gör</a></div>
        </div>
        <div class="row g-3">
            <div class="col-md-9">
                <div class="row g-3">
            ...
            <div class="col-md-3">
                <ul class="list-unstyled blog-entry-sm">
                    ...
                    <li>
                        ...
                        <p>{{ $post->description}}</p>
                        <p><a href="{{ route('posts.single', $post->id)}}" class="read-more">Okumaya devam et</a></p>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="blog-entry">
                    ...
                    <span class="date">{{ $post->created_at}}</span>
                    <h2><a href="single.html">{{ substr($post->title, 0, 35)}}</a></h2>
...
<section class="section posts-entry">
    <div class="container">
        <div class="row mb-4">
            <div class="col-sm-6">
                <h2 class="posts-entry-title">Kültür</h2>
            </div>
            <div class="col-sm-6 text-sm-end"><a href="category.html" class="read-more">Hepsini Gör</a></div>
        </div>
        <div class="row g-3">
...
<section class="section">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-sm-6">
                <h2 class="posts-entry-title">Politika</h2>
            </div>
            <div class="col-sm-6 text-sm-end"><a href="category.html" class="read-more">Hepsini Gör</a></div>
        </div>
...
<div class="section bg-light">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-sm-6">
                <h2 class="posts-entry-title">Gezi</h2>
            </div>
            <div class="col-sm-6 text-sm-end"><a href="category.html" class="read-more">Hepsini Gör</a></div>
        </div>
