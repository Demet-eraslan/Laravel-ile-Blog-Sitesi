...
@section('content')
<div class="site-cover site-cover-sm same-height overlay single-page" style="margin-top: -25px; background-image: url('{{ asset('assets/images/hero_1.jpg')}}');">
    <div class="container">
      <div class="row same-height justify-content-center">
        
        <div class="col-md-6">
          <div class="post-entry text-center">
            <img style="width: 70px; heighth:70px" src="{{ asset('assets/user_images/'.$profile->image.'')}}">
      ...
      <div class="row blog-entries element-animate">
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div style= "padding: 29px; margin-left:710px; margin-top: -56px; width: 321px" class="sidebar-box">
            <h3 class="heading">Son Gönderileri</h3>
